...
Como $A$ é crescente, se $\op\notin A$ e $\opd\in A$, então há elos $e \in \mathcal{G}$ tais que
...
Observemos agora que a ocorrência ou não do evento \{$e$ é essencial em $\op$ para $A$\} não depende de $\omega(e)$.
